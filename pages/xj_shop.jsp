...
<html>
	...
	<tbody>
	<c:forEach items="${shoplist}" var="li" >
	<tr>
	<th scope="row">${li.name}</th>
	
	<td>${li.tele}</td>
	<td>
	<button onclick="purchasetz(${sid},${li.sid})">通知采购</button>
	...
	function purchasetz(sid,shopsid){
		
		
			 $.ajax({
		          url: "/DM/purchasetz.html",
		          data: {"sid":sid,"shopsid":shopsid},
		          type: "GET",
		          datatype:"text",
