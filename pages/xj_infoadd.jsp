...
<html>
	...
	<a href="signin.html" class="dropdown-item">退出</a>
		...
		<div class="mb-3">
	    <label >区号</label>
		<input type="text" class="form-control" id="area" name="area"  placeholder="a/b/c"/>
		</div>
		<div class="mb-3">
		...
		<button style='border:none;color:#0000EE;' onclick="addxjinfo()">确认提交</button>
		</div>
		</form>
	...
	<script type="text/javascript">
      ...
      function addxjinfo(){
 		 ...
 		 $.ajax({
 	          url: "/DM/addxjinfo.html",
 	          data:{"area":area,"content":content},
 	          type: "GET",
 	          datatype:"text",
