...
<html>
	...
	<h3 class="text-primary">学生信息修改</h3>
	</a>
	...
	<a href="signin.html" class="dropdown-item">退出</a>
		...
		<div class="mb-3">
		<label >学号</label>
		<input type="text" id="snum" name="snum" class="form-control" value="${stu.snum}"/>
		</div>
		<div class="mb-3">
	    <label >姓名</label>
		...
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">寝室号</label>
		<input type="text" class="form-control" id="rmname" name="rmname"  value="${stu.rmname}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">专业</label>
		<input type="text"  class="form-control" id="majo" name="majo"  value="${stu.majo}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">年级</label>
		<input type="text"  class="form-control" id="leve" name="leve"  value="${stu.leve}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">班级</label>
		<input type="text"  class="form-control" id="clas" name="clas"  value="${stu.clas}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">电话</label>
		<input type="text"  class="form-control" id="tele" name="tele"  value="${stu.tele}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">辅导员工号</label>
		<input type="text"  class="form-control" id="fdmnum" name="fdynum"  value="${stu.fdynum}"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">家住址</label>
		<input type="text"  class="form-control" id="home" name="home"  value="${stu.home}"/>
		</div>
		<div class="input-group">
		<button style='border:none;color:#0000EE;' onclick="stuupdateinfo()">确认提交</button>
		</div>
		</form>
	...
	<script type="text/javascript">
      ...
      function stuupdateinfo(){
  		var snum = document.getElementById("snum").value;
  		var name = document.getElementById("name").value;
  		var rmname = document.getElementById("rmname").value;
  		var majo = document.getElementById("majo").value;
  		var leve = document.getElementById("leve").value;
  		var clas = document.getElementById("clas").value;
  		var tele = document.getElementById("tele").value;
  		var fdynum = document.getElementById("fdynum").value;
  		var home = document.getElementById("home").value;
  		
 		 $.ajax({
 	          url: "/DM/stuupdate.html",
 	          data:{"snum":snum,"name":name,"rmname":rmname,"majo":majo,"leve":leve,"clas":clas,"tele":tele,"fdynum":fdynum,"home":home},
 	          type: "GET",
 	          datatype:"text",
