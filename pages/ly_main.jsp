...
<html>
	...
	<a href="*" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>申请审批</a>
	<div class="dropdown-menu bg-transparent border-0">
	<a  href="javascript:void(0);" onclick="tscl(${RT.account})" class="dropdown-item">退宿申请审批</a>
	<a  href="javascript:void(0);" onclick="lscl(${RT.account})" class="dropdown-item">留宿申请审批</a>
	<a  href="javascript:void(0);" onclick="bxcl(${RT.account})" class="dropdown-item">报修申请审批</a>
	<a  href="javascript:void(0);" onclick="wzcl(${RT.account})" class="dropdown-item">物资申请审批</a>
	<a  href="javascript:void(0);" onclick="jycl(${RT.account})" class="dropdown-item">就医申请审批</a>
	<a  href="ljtz.html"  class="dropdown-item">通知</a>
	</div>
	</div>
	...
	<button onclick="fjfloorcx(${RT.account})" style=' border:none;color:#0000EE;'>按楼层查询</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button style=' border:none;color:#0000EE;' onclick="fjqcx(${RT.account})">全部房间</button>
	<br><br>
	</div>
	<div class="table-responsive">
	...
	<script type="text/javascript">
     ...
     function fjfloorcx(account){
    	 var inputid=document.getElementById("fjcxvalue");
		 var value = inputid.value;
		 var tablename = document.getElementById('fjcxjgtable');
	      var row = tablename.insertRow(tablename.rows.length);
		 $.ajax({
	          url: "/DM/fjfloorcx.html",
	          data:{"floor":value,"account":account},
	          type: "GET",
	          datatype:"text",
	          success: function(data) {
	        	  var obj = jQuery.parseJSON(data);
	...
	var name = document.getElementById("name"+j).innerHTML;
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="tzcheckroommate.html";
	        	  },
		          error: function(data){
	                    alert("请求失败");
	           }})
	...
	function tscl(account){
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="tstz.html";
	...
	function wzcl(account){
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="wzcltz.html";
	...
	function lscl(account){
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="lstz.html";
	...
	function bxcl(account){
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="bxtz.html";
	...
	function jycl(account){
		 ...
		 $.ajax({
	          ...
	          datatype:"text",
	          success: function(data) {
	        	  window.location.href="jytz.html";
