...
<html>
	...
	<h3 class="text-primary">学生留宿申请</h3>
	</a>
	...
	<div class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
		...
		<h6 class="mb-4">留宿填报</h6>
		
		<form action="lssubmit.html" method="post" id="form_lssubmit">
		<div class="mb-3">
		...
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">截止日期</label>
		<input type="datetime-local" class="form-control" id="enddate" name="enddate"/>
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">楼宇负责人工号</label>
		<input type="text"  class="form-control" id="lywnum" name="lywnum"/>
		</div>
		<div class="input-group">
		<span class="input-group-text">原因</span>
		<textarea class="form-control" aria-label="With textarea" id="reason" name="reason"></textarea>
		</div>
		<div class="input-group">
		<input type="submit" />
		</div>
