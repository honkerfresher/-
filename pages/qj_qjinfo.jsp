...
<html>
	...
	<h3 class="text-primary">区级管理员</h3>
	</a>
	...
	<h6 class="mb-4">区级通知</h6>
	<div class="table-responsive">
	<table class="table" id="qjtz"><button style="border:none;color:blue;" ><a href="qj_infoadd.html">发通知</</a></button>
	<thead>
	<tr>
	<th scope="col">楼号</th>
	<th scope="col">内容</th>
	...
	<script >
	 ...
	 function qjtz(){
		 ...
		 var tablename = document.getElementById('qjtz');
	      var row = tablename.insertRow(tablename.rows.length);
	      $.ajax({
	          url: "/DM/qjtzdata.html",
	        	  ...
	        	  var col;
	                  ...
	                  if(obj.tzlist!=""){
		                   ...
		                   for(var j=0;j<tz.length;j++){
		                                                 ...
		                                                 col.innerHTML = tzinfo[0];//放入新的信息的第一个字段
		                                                 col = row.insertCell(1);
		                                                 col.innerHTML = tzinfo[1];
		                                                 col.id="name"+j;
