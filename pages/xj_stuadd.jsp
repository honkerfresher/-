...
<html>
	...
	<a href="signin.html" class="dropdown-item">退出</a>
		...
		<input type="text"  class="form-control" id="majo" name="majo" />
		</div>
		<div class="mb-3">
		<label for="exampleInputEmail1" class="form-label">年级</label>
		<input type="text"  class="form-control" id="leve" name="leve" />
		</div>
		<div class="mb-3">
		...
		<button style='border:none;color:#0000EE;' onclick="stuaddinfo()">确认提交</button>
		</div>
		</form>
