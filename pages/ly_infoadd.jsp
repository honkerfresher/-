...
<html>
	...
	<a href="signin.html" class="dropdown-item">退出</a>
		...
		<form action="" method="" id="form_lssubmit">
		
		<div class="mb-3">
	    <label >楼层号</label>
		<input type="text" class="form-control" id="lc"  placeholder="1/2/3/4/5/6/7"/>
		</div>
		<div class="mb-3">
		...
		<button style='border:none;color:#0000EE;' onclick="addljinfo(${RT.account})">确认提交</button>
		</div>
		</form>
