...
<html>
	...
	<h3 class="text-primary">校级管理员</h3>
	</a>
	...
	<h6 class="mb-4">校级通知</h6>
	<div class="table-responsive">
	<table class="table" id="xjtz"><button style="border:none;color:blue;" ><a href="xj_infoadd.html">发通知</</a></button>
	<thead>
	<tr>
	<th scope="col">区号</th>
	<th scope="col">内容</th>
	...
	<script >
	 ...
	 function xjtz(){
		 ...
		 var tablename = document.getElementById('xjtz');
	      var row = tablename.insertRow(tablename.rows.length);
	      $.ajax({
	          url: "/DM/xjtzdata.html",
